...
@section('content')
    <x-core::form class="form-import-data mb-3" :url="route('import-companies.store')" method="post">
        <x-core::card>
            <x-core::card.header>
                <x-core::card.title>
    ...
    @include('plugins/job-board::import.partials.template', ['headings' => $headings, 'data' => $companies])
